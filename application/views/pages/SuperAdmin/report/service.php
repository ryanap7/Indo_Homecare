			...
			<div class="section-body">
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<form method="post" class="needs-validation" action="<?php echo site_url('admin/report/print_layanan') ?>" novalidate="">
									<div class="row">
										<div class="form-group col-2">
											<label>Filter by Bulan</label>
											<select class="form-control selectric" id="filter3" name="bulan">
