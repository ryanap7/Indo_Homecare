		...
		<div class="row">
				...
				<div class="card card-statistic-1">
					...
					<div class="card-wrap">
						<div class="card-header">
							<a href="<?= base_url('superadmin/client') ?>">
								<h4> Total Client</h4>
							</a>
						</div>
						<div class="card-body">
			...
			<div class="col-lg-4 col-md-4 col-sm-12">
				<div class="card card-statistic-2">
					<div class="card-header">
						<div class="col-6">
							<a href="<?= base_url('superadmin/report/ambulance') ?>">
			...
			<div class="col-lg-6">
				<div class="card">
					...
					<div class="card-body">
						<div class="col-4">
							Tahun
							<select class="form-control selectric " name="tahun" id="tahunkeuangan">
								<option value="0000" selected>-- Show All --</option>
								<?php
								$mulai = date('Y') - 5;
								for ($i = $mulai; $i < $mulai + 100; $i++) {
						...
						<div id="statistikkeuangan" style="width: 600px; height: 350px;"></div>
					</div>
				</div>
			</div>
