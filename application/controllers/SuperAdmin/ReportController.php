...
class ReportController extends CI_Controller
{
    ...
    public function pengeluaran()
	{
		if ($this->session->userdata('role') === '1') {
			...
			$this->load->view('pages/SuperAdmin/report/index.php', $data);
		} else {
			redirect('/');	
		}
	}
    ...
    public function ambulance()
	{
		if ($this->session->userdata('role') === '1') {
			...
			$this->load->view('pages/SuperAdmin/report/ambulance.php', $data);
		} else {
			redirect('/');	
		}
	}
    ...
    public function alkes()
	{
		if ($this->session->userdata('role') === '1') {
			...
			$this->load->view('pages/SuperAdmin/report/alkes.php', $data);
		} else {
			redirect('/');	
		}
    }
    ...
    public function service()
	{
		if ($this->session->userdata('role') === '1') {
			...
			$this->load->view('pages/SuperAdmin/report/service.php', $data);
		} else {
			redirect('/');	
		}
	}
