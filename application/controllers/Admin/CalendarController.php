...
class CalendarController extends CI_Controller {
	...
	public function ambulance() {
		if ($this->session->userdata('role') === '2') {
			...
			$this->load->view('pages/Admin/calendar/ambulance.php', $data);
		} else {
			redirect('/');
		}
	}
	...
	public function service() {
		if ($this->session->userdata('role') === '2') {
			...
			$this->load->view('pages/Admin/calendar/service.php', $data);
		} else {
			redirect('/');
		}
	}
	...
	public function alkes() {
		if ($this->session->userdata('role') === '2') {
			...
			$this->load->view('pages/Admin/calendar/alkes.php', $data);
		} else {
			redirect('/');
		}
	}
